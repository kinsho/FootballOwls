		...
		for year, weeks in records.iteritems():
			...
			for week, games in weeks.iteritems():
				...
				for index, game in enumerate(games):
					...
					print("{} accumulated a total of {} yards over {} attempts".format(away_team, away_team_ty, away_team_att))
					print("{} accumulated a total of {} yards over {} attempts".format(home_team, home_team_ty, home_team_att))
					print("\n")
